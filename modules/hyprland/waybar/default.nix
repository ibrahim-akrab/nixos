  ...
  flake.modules = {
    ...
    homeManager.hyprland =
      ...
      let
        ...
        # Workspace configuration with common format-icons
        workspaceConfig = {
          on-click = "activate";
          format = "{icon}";
          format-icons = {
        ...
        # Function to create bar config for a monitor
        mkBarConfig = output: workspaces: commonModules // {
          inherit output;
          layer = "top";
          position = "top";
          spacing = 0;
      ...
      in
      {
        ...
        programs.waybar = {
          enable = true;
          settings = [
            (mkBarConfig "eDP-1" [ 1 2 3 4 5 ])
            (mkBarConfig "HDMI-A-1" [ 6 7 8 9 10 ])
          ];
        };
      };
  };
